class Link < ActiveRecord::Base
  ...
  # TODO: Любые операции (покупка или продление) чтобы не вступали в силу пока я не одобрю. Помощник новый и возможны ошибки при заполнении. Потом в этом хаосе труднее будет разобраться.
  ...
  # TODO: ограничение по методам оплаты - Видеть ПейПал и не видеть ВебМани или наоборот.
